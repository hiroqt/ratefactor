/*
 * @adykrni · OpenShaders
 * https://openshaders.com/@adykrni
 * WebGL2 · React component (TypeScript)
 *
 * import { AdykrniShader } from "./AdykrniShader.webgl.tsx";
 *
 * <AdykrniShader theme="dark" style={{ width: 480, height: 300 }} />
 *
...
const float HUE = 0.183563322;
const float HUE_SPREAD = -0.434864253;
const float HUE_TRAVEL = 1.86595309;
const float CHROMA = 0.147115573;
const float LIGHTNESS = 0.487473577;
const float COLOUR_CYCLE = 0.0931247994;
...
const float WARP_AMP_Y = 0.0279671345;
const float ASPECT_X = 2.24720263;
const float ASPECT_Y = 0.149952278;
const float OFFSET_X = 0.316815466;
const float OFFSET_Y = 0.0208540838;
const float TILT = -2.1717484;
const float ZOOM = 1.13440859;
const float CENTRE_X = 0.287210077;
const float CENTRE_Y = -0.467140168;
const float GLOW_SIZE = 0.00252000312;
const float FALLOFF = 0.425080121;
const float VIGNETTE = 0.1266433;
const float FLOW_SPEED = 0.595987439;
const float FLOW_DIRECTION = -1.0;
const float BREATH_RATE = 0.472419083;
const float BREATH_AMOUNT = 0.0849761665;
const float PHASE = 23.2212124;
const float ECHO = 0.347826034;
const float ECHO_SHIFT = 0.154436678;
const float SOFTNESS = 0.00206797151;
const float LIGHT_SWING = 0.17152217;
...
export type AdykrniShaderProps = {
  theme?: ShaderTheme;
  background?: { dark?: string; light?: string };
  time?: number;
  onError?: (error: Error) => void;
...
export function AdykrniShader({ theme = "dark", background, time, onError, className, style }: AdykrniShaderProps) {
