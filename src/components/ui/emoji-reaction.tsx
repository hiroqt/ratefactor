...
const label = (name: string) => {
  if (name === "star-struck") return "wow";
  if (name === "smiling-face-with-hearts") return "hearts";
  if (name === "neutral-face") return "meh";
  if (name === "thumbs-up") return "like";
        ...
        <Trigger
          ...
          className={
            asChild
              ? undefined
              : cn(
                  "relative z-10 grid place-items-center rounded-full text-slate-950/60 transition-colors hover:text-slate-950 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-950 dark:text-slate-50/60 dark:hover:text-slate-50 dark:focus-visible:ring-slate-300",
                  SURFACE,
                  s.trigger,
                )
          }
